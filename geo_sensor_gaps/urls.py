...
urlpatterns = [
    ...
    path('estimated_data_file/<int:timestamp_idx>', views.get_estimates_at_timestamp),
    path('estimated_data_diffusion/<int:timestamp_idx>', views.get_diffusion_estimates_at_timestamp),
    path('estimated_data_distance/<int:timestamp_idx>', views.get_distance_estimates_at_timestamp),
